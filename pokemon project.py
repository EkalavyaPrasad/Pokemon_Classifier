...
dataset = PokemonDataset(csv_file=r"C:\Users\herop\Downloads\python\archive (1)\pokemon.csv", 
                         root_dir=r"C:\Users\herop\Downloads\python\archive (1)\images", 
                         transform=transform)
...
class MLP(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(120 * 120 * 3, 1024)  # Adjusted input size
        self.fc2 = nn.Linear(1024, 784)
        self.fc3 = nn.Linear(784, 256)
        self.fc4 = nn.Linear(256, 128)
        self.fc5 = nn.Linear(128, 64)
        self.fc6 = nn.Linear(64, 18)  # Assuming there are 18 unique Pokemon types
...
image_path = r"C:\Users\herop\OneDrive\Desktop\Test.png"
